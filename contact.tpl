...
<div id="natix-host-contact-form">
<div class="card mb-4">
    <div class="card-body">

        <div class="mb-4">
            <h6 class="h3 text-center mb-xl-3 mb-lg-3 mb-md-3 mb-sm-3 mb-2">Contact Us</h6>
            <p class="text-muted mb-0 text-center mb-xl-5 mb-lg-5 mb-md-5 mb-sm-3 mb-2">{lang key='readyforquestions'}</p>
        </div>
