                ...
                *}
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{$WEB_ROOT}/index.php">Home<span
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu list-unstyled hosting-dropdown" aria-labelledby="navbarDropdown">
                                <ul class="dropdown-menu-list list-unstyled">
                                    <li> <a class="dropdown-item scroll hosting-menu"
                                            href="{$WEB_ROOT}/sharedhosting.php?systpl=Natix-Host"><img
                                                src="{$WEB_ROOT}/templates/{$template}/assets/images/dropdown-menu-img-1.png"
                                                alt="">Shared Hosting</a></li>
                                    <li> <a class="dropdown-item scroll server-menu"
                                            href="{$WEB_ROOT}/dedicatedserver.php?systpl=Natix-Host"><img
                                                src="{$WEB_ROOT}/templates/{$template}/assets/images/dropdown-menu-img-2.png"
                                                alt="">Dedicated Servers</a></li>
                                    <li> <a class="dropdown-item scroll vps-menu"
                                            href="{$WEB_ROOT}/vpsserver.php?systpl=Natix-Host"><img
                                                src="{$WEB_ROOT}/templates/{$template}/assets/images/dropdown-menu-img-3.png"
                                                alt="">VPS Servers</a></li>
                                    <li> <a class="dropdown-item scroll reseller-menu"
                                            href="{$WEB_ROOT}/reseller.php?systpl=Natix-Host"><img
                                                src="{$WEB_ROOT}/templates/{$template}/assets/images/dropdown-menu-img-4.png"
                                                alt="">Reseller Hosting</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu-list list-unstyled" id="pages-dropdown-list">
                                    <li class="nav-item">
                                        <a class="nav-link scroll"
                                            href="{$WEB_ROOT}/domain.php?systpl=Natix-Host">Domain</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link scroll"
                                            href="{$WEB_ROOT}/support.php?systpl=Natix-Host">Support</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link scroll"
                                            href="{$WEB_ROOT}/datacenter.php?systpl=Natix-Host">Data Center</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link scroll"
                                            href="{$WEB_ROOT}/affiliate.php?systpl=Natix-Host">Affiliate</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link scroll"
                                            href="{$WEB_ROOT}/ssl-certificate.php?systpl=Natix-Host">SSL Certificate</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link scroll"
                                href="{$WEB_ROOT}/contact-natix.php?systpl=Natix-Host">Contact</a>
                        </li>

                    </ul>
                    <ul class="float-xl-right natix-host-collapse-last-child">
                        <li class="nav-item">
                            <a class="navbar-btn nav-link scroll button-effect" href="index.php?rp=/login">Client
                                Area</a>
                        </li>
                    </ul>
                </div>
