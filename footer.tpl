...
{if $templatefile == 'homepage'}
 {include file="$template/templates/review-section.tpl"}
 {/if}


 {include file="$template/templates/contact-ticket.tpl"}
    ...
    {include file="$template/templates/footer-section.tpl"}


    {include file="$template/templates/footer-bar.tpl"}
